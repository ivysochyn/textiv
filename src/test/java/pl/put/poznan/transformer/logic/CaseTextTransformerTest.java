...
class CaseTextTransformerTest {
    ...
    public void createTransformerCapitalize() {
        ...
        textCapitalizeTransformer = TextTransformerCreator.createTextTransformer(textCapitalizeTransformer);
    ...
    public void BigSentenceTransformationCapitalizeTest() {
        String text = "i am a student at the poznan university of technology, majoring in computer science";
        String expected = "I Am A Student At The Poznan University Of Technology, Majoring In Computer Science";
        String actual = textCapitalizeTransformer.transform(text);
        assertEquals(expected, actual);
    }
